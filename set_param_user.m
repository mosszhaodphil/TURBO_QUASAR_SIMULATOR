...
function [] = set_param_user(varargin)
	...
	param_user_str.tau_t_gm              = 0.68; % Bolus arrival time to GM tissue
	...
	param_user_str.delta_ti_gap_factor   = 2; % number of delta_TIs between each successive bolus (default is 1)
	...
	param_user_str.slice_shifting_factor = 1; % Factors of slice shifting
	param_user_str.actual_sampling_rate  = param_user_str.delta_ti / param_user_str.slice_shifting_factor;
	param_user_str.t                     = 0.04 : param_user_str.actual_sampling_rate : 10; % sampling time points, second variable must be equal to actual sampling rate (Default: 11 TIs)

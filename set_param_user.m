...
function [] = set_param_user(varargin)
	...
	param_user_str.f_wm                  = 0 / 6000; % WM CBF needed to convert from ml/100ml/min to ml/g/s
	...
	param_user_str.t                     = 0.34 : param_user_str.actual_sampling_rate : 7; % sampling time points, second variable must be equal to actual sampling rate (Default: 11 TIs)
	...
	param_user_str.pvgm                  = 'mask_bin'; % 'mask_bin'; % file name of PV GM map
	param_user_str.pvwm                  = 'mask_bin'; % 'mask_bin'; % file name of PV WM map
	param_user_str.abv_mask              = 'abv_mask'; % 'mask_abv'; file name of ABV mask (currently all zeros)
